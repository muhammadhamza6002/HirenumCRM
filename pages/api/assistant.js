...
You must respond with a JSON object (raw JSON, no markdown, no code fences) with this exact shape:
{
  ...
  "linkedin_url": "The LinkedIn profile URL if literally present in the pasted text (e.g. linkedin.com/in/johndoe). Do NOT guess or construct URLs. Empty string if not literally in the text.",
